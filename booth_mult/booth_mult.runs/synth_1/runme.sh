...
HD_PWD='E:/RISCV/booth/booth_mult/booth_mult.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log pp_generator.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source pp_generator.tcl
